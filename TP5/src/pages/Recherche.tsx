...
export function Recherche() {
  ...
  return (
    <div>
      <h1 className="mb-6 text-2xl font-bold">Recherche de films</h1>
      ...
      <input
        ...
        className="w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400 dark:border-slate-700 dark:bg-slate-800"
      />
